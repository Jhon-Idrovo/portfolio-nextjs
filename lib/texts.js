export const en = {
  ...
  services: [
    {
      t: "Desarroll a partir de diseño",
      d: "Tienes ya un diseño de como quieres que se vea y funcione tu sitio pero necesitas a alguien que lo lleve a la realidad?. Puedo hacerlo, partire de cualquier diseño y requerimientos que tengas para poder hacer tu sueño realidad.",
    },
    {
      t: "Desarrollo en proyecto existente",
      d: "Puedo continuar con el desarrollo de tu sitio web en cualquier etapa que este se encuentre, manteniendo la consistencia con el trabajo realizado hasta el momento",
    },
    {
      t: "Desarrollo desde 0",
      d: "Este es el paquete mas completo. Partiendo desde 0 recacabare toda la informacion necesria para diseñar, construir, probar y poner a la vista tu sitio web. ",
    },
  ],
...
export const es = {
  navMenuItems: ["Inicio", "Portafolio", "Servicios", "Sobre Mi", "Contratame"],
  ...
  benefits: [
    ...
    {
      title: "Good looking",
      desc: 'Tu pagina web tendra una apripiada combinacion de colores, imagenes, animaciones y mas que sacaran un "Guaao!" a tus usuarios',
