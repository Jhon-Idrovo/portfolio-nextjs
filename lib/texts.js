  ...
  benefits: [
    {
      ...
      desc: "Tu website sera intuitiva y facil de usar, dando pistas a tus usuarios para que encuentren lo que necesitan facilmente. Evita que tus visitantes abandonen tu pagina.",
      descExtended: "carga rapida, optimizaciones",
      exSrc: "/images/examples/craftsman-s.gif",
    },
    {
      title: "Atractiva",
      desc: "Tu website tendra una apropiada combinacion de colores, imagenes, animaciones y mas que haran saber a tus visitantes que tienes la calidad necesaria. Ademas, resalto las cosas impotantes para que tus visitantes no las ignoren. ",
      descExtended: "Resaltan lo que tu deseas",
      exSrc: "/images/examples/home-finance-login.png",
    },
    {
      title: "Diseño Responsivo - Mobile/Desktop",
      desc: "Tu pagina se adaptara al tipo de dispositivo que tus visitantes usan, ya sea una computadora, tablet o smartphone sin perder calidad. Permite que tus usuarios tengan una experiencia homogenea, dandoles mayor confianza y seguridad en ti.",
      descExtended: "",
      exSrc: "/images/examples/responsive-website-design-development.png",
    },
    {
      title: "La funcionalidad que necesites",
      desc: "Integra funciones de diversa complejidad en tu sitio tales como calculadoras, gráficos estadisticos dinamicos, carga y descarga de archivos, entre otras. Este tipo de funcionalidad no se puede conseguir usando una plantilla y puede ser un factor claves de diferenciación para ti. ",
      descExtended: "",
